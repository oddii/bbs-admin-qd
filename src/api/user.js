export default {
    ...
    updateUserAvatar: 'http://forum.frp.wegfan.cn/api/user/update-avatar', // 修改用户头像
    ...
    updateBoardAdmin: '/api/user/update-board-admin', //  更新版主
    updateCategoryAdmin: '/api/user/update-category-admin', //  更新分区版主
